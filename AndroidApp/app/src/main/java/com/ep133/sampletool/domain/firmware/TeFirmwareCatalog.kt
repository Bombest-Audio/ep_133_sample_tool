 ...
 *
 * Supersedes the earlier TE-downloads-page scrape, which pulled garbage tokens out of inline
 * SVG path data (e.g. "50.9332"). Uses a plain [HttpURLConnection] on [Dispatchers.IO] — no HTTP
 * library dependency. Any failure is logged via [Log.w] and resolved to [LATEST_KNOWN_FIRMWARE]
 * by the floor.
 */
